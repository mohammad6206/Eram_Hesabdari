...
export default function BuyInvoiceList() {
    ...
    useEffect(() => {
        fetch(`${API_URL}/api/sell-invoices/`)
            .then((res) => res.json())
            .then((data) => {
                setInvoices(data);
                setLoading(false);
    ...
    const handleDelete = (id) => {
        ...
        fetch(`${API_URL}/api/sell-invoices/${id}/`, { method: "DELETE" })
            .then(() => {
    ...
    const handleSaveEdit = () => {
        fetch(`${API_URL}/api/sell-invoices/${selectedInvoice.id}/`, {
            method: "PUT",
            headers: {
